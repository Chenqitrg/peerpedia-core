...
| 17 | [commands/sync.py](../peerpedia_core/commands/sync.py) | `apply_sync_bundle` / `git_sync_reviews` / `git_sync_status` | sync 后同步评审到 DB |
...
| 序号 | 文件 | 读什么 |
|------|------|--------|
| 24 | [cli/__init__.py](../peerpedia_core/cli/__init__.py) | `main()` 入口、启动扫描、命令 dispatch |
| 25 | [cli/parser.py](../peerpedia_core/cli/parser.py) | argparse 结构 |
| 26 | [cli/handlers/](../peerpedia_core/cli/handlers/) | 每个子命令的 handler |
| 27 | [repl.py](../peerpedia_core/repl.py) | prompt_toolkit REPL、定时扫描 |
| 28 | [compiler.py](../peerpedia_core/compiler.py) | Markdown→HTML、Typst→PDF/SVG/PNG、frontmatter 解析 |
...
| 评审如何从 git 同步到 DB？ | [commands/sync.py](../peerpedia_core/commands/sync.py) → `git_sync_reviews` |
